"""Command-line interface for Board of Directors Agents."""
...
from board.agents.indian_philosophy import IndianPhilosophyAgent
from board.agents.ruthless_capitalist import RuthlessCapitalistAgent
from board.agents.synthesis import SynthesisAgent
from board.runtime.providers import get_provider
...
def doctor() -> None:
    ...
    console.print("[bold blue]Board of Directors Agents - System Check[/bold blue]")
    console.print()
...
def critique(
    ...
    """Get critique from AI board of directors."""
    ...
    try:
        ...
        console.print("Run `board doctor` to diagnose issues.")
        raise typer.Exit(1)
    
    console.print("[bold blue]Board of Directors Agents[/bold blue]")
    ...
    if lens:
        ...
        # Synthesis
        with console.status("[bold green]Synthesizing board feedback..."):
...
def _format_markdown_output(results: list[AgentOutput], input_name: str) -> str:
    ...
    lines = [
        ...
        "",
        f"*Generated by Board of Directors Agents*",
        "",
    ]
...
def version() -> None:
    ...
    console.print(f"Board of Directors Agents v{__version__}")
