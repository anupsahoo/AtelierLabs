...
class MentalModelInjectorAgent(CognitiveAgent):
    """Agent implementation coming soon."""

    def __init__(self):
        super().__init__(
            name="MentalModelInjector",
            category="cognitive",
            mental_models=[],
    ...
    async def process_input(self, input_data, context=None) -> AgentResult:
        raise NotImplementedError("MentalModelInjectorAgent is not implemented yet")