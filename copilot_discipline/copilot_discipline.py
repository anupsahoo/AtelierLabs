...
class CopilotDisciplineAgent(CognitiveAgent):
    """Agent implementation coming soon."""

    def __init__(self):
        super().__init__(
            name="CopilotDiscipline",
            category="ai_future",
            mental_models=[],
    ...
    async def process_input(self, input_data, context=None) -> AgentResult:
        raise NotImplementedError("CopilotDisciplineAgent is not implemented yet")