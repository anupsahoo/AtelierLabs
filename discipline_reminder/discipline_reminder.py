...
class DisciplineReminderAgent(CognitiveAgent):
    """Agent implementation coming soon."""

    def __init__(self):
        super().__init__(
            name="DisciplineReminder",
    ...
    async def process_input(self, input_data, context=None) -> AgentResult:
        raise NotImplementedError("DisciplineReminderAgent is not implemented yet")