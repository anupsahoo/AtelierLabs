...
class NarrativeFramerAgent(CognitiveAgent):
    """Agent implementation coming soon."""

    def __init__(self):
        super().__init__(
            name="NarrativeFramer",
            category="strategy",
            mental_models=[],
    ...
    async def process_input(self, input_data, context=None) -> AgentResult:
        raise NotImplementedError("NarrativeFramerAgent is not implemented yet")